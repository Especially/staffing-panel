...
background-position: 50% 50%;
background-size: cover;">
<form id="location_form" action="javascript:void(0);">
    <fieldset>
...
<select name="city" id="city" class="city">
        ...
        <label><span>&nbsp;</span>
        <button id="verify" type="submit" class="submit_btn">Add Location</button>
        </label>
    </fieldset>
    </form>
    </div>
...
$(document).ready(function () {
    $("#verify").click(function () {
        ...
        if (proceed) {
            ...
            post_data = {'name': name, 'check1': check1, 'check2': check2, 'check3': check3, 'type': type, 'tnum': tnum, 'number': number, 'alternate': alternate, 'street': street, 'postal': postal, 'city': city, 'majint': majint, 'comments': comments};

            //Ajax post data to server
            $.post(''+root+'NewLPush.php', post_data, function (response) {
