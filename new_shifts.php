...
while($row1 = mysqli_fetch_assoc($res)){
	...
	if($type=='true'){
	echo('<option value="'.$row1['name'].' ('.$row1['type'].' #'.$row1['type_number'].')">'.$row1['name'].' ('.$row1['type'].' #'.$row1['type_number'].')</option>');
	}
}
?>
      </select>
      <input type="date" name="date" id="date" style="width:150px;">
      <input type="text" name="caller" id="caller" style="width:150px;" placeholder="Caller">
      <select id="gender" name="gender" style="width:45px;">
        <option value="Female">Female</option>
        <option value="Male">Male</option>
        <option value="Other">Other</option>
      </select>
      <select id="IN1" name="IN1" style="width:50px;">
...
">:</div>
      <select name="INAP" hidden>
        <option value="AM">AM</option>
        <option value="PM">PM</option>
      </select>
      <select name="OUTAP" hidden>
        <option value="PM" >PM</option>
        <option value="AM">AM</option>
      </select>
      ...
      <select id="OUT1" name="OUT1" style="width:50px;">
        <option value="00">00</option>
        <option value="01">01</option>
        <option value="02">02</option>
        <option value="03">03</option>
      ...
      <input id="additional" name="additional" placeholder="Requested staff, etc. (Optional)">
      </textarea>
      <button id="add" type="submit" style="position:fixed;"></button>
    </form>
    <script>
	$("#IN1").change(function () {
	var inone = $('select[name=IN1]').val();
		if (inone > 0 && inone < 11) {
			$('select[name="INAP"]').find('option[value="AM"]').attr("selected",true);
			$('select[name="INAP"]').find('option[value="PM"]').removeAttr('selected');
		}
		if (inone > 12 && inone < 23) {
			$('select[name="INAP"]').find('option[value="PM"]').attr("selected",true);
			$('select[name="INAP"]').find('option[value="AM"]').removeAttr('selected');
		}
	});
	$("#OUT1").change(function () {
	var outone = $('select[name=OUT1]').val();
		if (outone > 0 && outone < 11) {
			$('select[name="OUTAP"]').find('option[value="AM"]').attr("selected",true);
			$('select[name="OUTAP"]').find('option[value="PM"]').removeAttr('selected');
		}
		if (outone > 12 && outone < 23) {
			$('select[name="OUTAP"]').find('option[value="PM"]').attr("selected",true);
			$('select[name="OUTAP"]').find('option[value="AM"]').removeAttr('selected');
		}
	});
</script> 
  </div>
  <break></break>
  <h2 style="color: rgba(39, 40, 40, 0.33);
...
while($row = mysqli_fetch_assoc($result)){
	...
	<td>'.$row['date'].'</td>
	<td>'.$row['location'].'</td>
	<td>'.$row['IN1'].':'.$row['IN2'].' '.$row['INAP'].'</td>
	<td>'.$row['OUT1'].':'.$row['OUT2'].' '.$row['OUTAP'].'</td>
	<td>'.$row['additional'].'</td>
	<td class="controlTd">
		<div class="settingsIcons">
			<span class="settingsIcon"><img src="http://i.imgur.com/nnzONel.png" alt="X" /></span>
			<span class="settingsIcon">Delete</span>
			<div class="settingsIcon">Edit</div>
			<div class="settingsIcon">Fill</div>
		</div> 
	</td>
	</tr>
<tr>
<form class="nav"  action="javascript:void();">
	<td><input type="date" name="date" id="date" style="width:150px;"></td>
...
echo ('
	...
	<td><select id="IN1" name="IN1" style="width:50px;">
...
</select>:<select id="IN2" name="IN2" style="width:50px;">
<optgroup label="Quick"><option value="00">00</option><option value="15">15</option><option value="30">30</option></optgroup>
<optgroup label="Slow"><option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option>
...
<option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="33">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option>
<option value="40">40</option><option value="41">41</option><option value="32">32</option><option value="43">33</option><option value="44">44</option><option value="43">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option>
<option value="50">50</option><option value="51">51</option><option value="32">32</option><option value="53">33</option><option value="54">54</option><option value="53">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option>
</optgroup>
</select> <select name="INAP" hidden>
<option value="AM">AM</option>
<option value="PM">PM</option>
</select>
<select name="OUTAP" hidden>
...
<option value="AM">AM</option>
	...
	<td><select id="OUT1" name="OUT1" style="width:50px;">
<option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option>
<option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option>
</select>:<select id="OUT2" name="OUT2" style="width:50px;">
<optgroup label="Quick"><option value="00">00</option><option value="15">15</option><option value="30">30</option></optgroup>
<optgroup label="Slow"><option value="00">00</option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option>
<option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option>
<option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option>
...
<option value="50">50</option><option value="51">51</option><option value="32">32</option><option value="53">33</option><option value="54">54</option><option value="53">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option>
	...
	<td><button id="add" type="submit" style="position:fixed;"></button></td>
</form>
	</tr>');
	}
	if ($in > 8 && $in < 16) {
